...
#define Offset(s, m) __int64(&(s->m)) - __int64(s)
#define OffsetFix(s, m, p) __int64(&(s->m)) + p - 1 - __int64(s)
#define OffsetN(s, m) __int64(&((&s)->m)) - __int64(&s)

template <typename O, typename N>
N Resize(O obj) {
    __int64 addr = __int64(&obj) + sizeof(O) - sizeof(N);
    return *(N*)addr;
}
...
static UNetDriver* (*CreateNetDriver)(void*, void*, FName) = decltype(CreateNetDriver)(__int64(GetModuleHandleA(0)) + 0x4573990);
static __int64* (*GetInventoryOwnerFromWeapon)(void*) = decltype(GetInventoryOwnerFromWeapon)(__int64(GetModuleHandleA(0)) + 0x25EE400);
static bool (*InitListen)(void*, void*, FURL&, bool, FString&) = decltype(InitListen)(__int64(GetModuleHandleA(0)) + 0xD44C40);
static void (*SetWorld)(void*, void*) = decltype(SetWorld)(__int64(GetModuleHandleA(0)) + 0x42C2B20);
static void (*ServerReplicateActors)(void*) = decltype(ServerReplicateActors)(__int64(GetModuleHandleA(0)) + 0x1023F60);
static UObject* (*StaticFindObjectOG)(UClass*, UObject* Package, const wchar_t* OrigInName, bool ExactClass) = decltype(StaticFindObjectOG)(__int64(GetModuleHandleA(0)) + 0x2E1C4B0);
static UObject* (*StaticLoadObjectOG)(UClass* Class, UObject* InOuter, const TCHAR* Name, const TCHAR* Filename, uint32_t LoadFlags, UObject* Sandbox, bool bAllowObjectReconciliation, void*) = decltype(StaticLoadObjectOG)(__int64(GetModuleHandleA(0)) + 0x2E1CD60);
static bool (*InternalTryActivateAbility)(UAbilitySystemComponent* AbilitySystemComp, FGameplayAbilitySpecHandle AbilityToActivate, FPredictionKey InPredictionKey, UGameplayAbility** OutInstancedAbility, void* OnGameplayAbilityEndedDelegate, const FGameplayEventData* TriggerEventData) = decltype(InternalTryActivateAbility)(__int64(GetModuleHandleA(0)) + 0x6B33F0);
static FGameplayAbilitySpecHandle* (__fastcall* GiveAbilityOG)(UAbilitySystemComponent*, FGameplayAbilitySpecHandle*, FGameplayAbilitySpec) = decltype(GiveAbilityOG)(__int64(GetModuleHandleA(0)) + 0x6B19E0);
static void (*FGameplayAbilitySpecCtor)(FGameplayAbilitySpec*, UGameplayAbility*, int, int, UObject*) = decltype(FGameplayAbilitySpecCtor)(__int64(GetModuleHandleA(0)) + 0x6D6DD0);
static __int64 (*CantBuild)(UWorld*, UObject*, FVector, FRotator, char, void*, char*) = decltype(CantBuild)(__int64(GetModuleHandleA(0)) + 0x1E57790);
static ABuildingSMActor* (*ReplaceBuildingActor)(ABuildingSMActor* BuildingSMActor, unsigned int a2, UObject* a3, unsigned int a4, int a5, bool bMirrored, AFortPlayerControllerAthena* PC) = decltype(ReplaceBuildingActor)(__int64(GetModuleHandleA(0)) + 0x1B951B0);
static __int64(__fastcall* GiveAbilityAndActivateOnce)(void*, FGameplayAbilitySpecHandle*, FGameplayAbilitySpec) = decltype(GiveAbilityAndActivateOnce)(__int64(GetModuleHandleA(0)) + 0x6B1B00);
static LPVOID(*ProcessEvent)(void*, void*, void*) = nullptr;
static void(*RemoveFromAlivePlayers)(AFortGameModeAthena*, AFortPlayerControllerAthena*, APlayerState*, AFortPlayerPawn*, UFortWeaponItemDefinition*, EDeathCause, char) = decltype(RemoveFromAlivePlayers)(__int64(GetModuleHandleA(0)) + 0x18ECBB0);
static void(*OnRep_ZiplineState)(AFortPlayerPawn*) = decltype(OnRep_ZiplineState)(__int64(GetModuleHandleA(0)) + 0x2298F10);
static void (*XPCompOnProfileReady)(void*, void*) = decltype(XPCompOnProfileReady)(__int64(GetModuleHandleA(0)) + 0x19A9980);
static bool (*ShowPerkSelect)(AFortAthenaMutator_PerkSystemMutator* Mutator, void* a2) = decltype(ShowPerkSelect)(__int64(GetModuleHandleA(0)) + 0x1A934C0);
static __int64 (*GetAccID1)(__int64, __int64) = decltype(GetAccID1)(__int64(GetModuleHandleA(0)) + 0x22DC390);
static __int64 (*GetAccID2)(__int64, __int64) = decltype(GetAccID2)(__int64(GetModuleHandleA(0)) + 0xAE5CB0);
void (*BotManagerSetupStuffIdk)(__int64 BotManaager, __int64 Pawn, __int64 BehaviorTree, __int64 a4, DWORD* SkillLevel, __int64 idk, __int64 StartupInventory, __int64 BotNameSettings, __int64 idk_1, BYTE* CanRespawnOnDeath, unsigned __int8 BitFieldDataThing, BYTE* CustomSquadId, FFortAthenaAIBotRunTimeCustomizationData InRuntimeBotData) = decltype(BotManagerSetupStuffIdk)(__int64(GetModuleHandleA(0)) + 0x19D93F0);
...
static char (*GameSession_KickPlayer)(AGameSession*, AController*) = decltype(GameSession_KickPlayer)(__int64(GetModuleHandleA(0)) + 0x20DFE60);
...
static string SessionName = "PlooshFNSession";
...
{
    for (UStruct* ObjClass = Object->Class; ObjClass; ObjClass = *(UStruct**)(__int64(ObjClass) + Offset(ObjClass, Super)))
    {

        FProperty* Property = *(FProperty**)(__int64(ObjClass) + Offset(ObjClass, ChildProperties));

        if (Property)
        {
            FName* PropFName = (FName*)(__int64(Property) + Offset(Property, Name));
            ...
            while (Property)
            {
                if (PropName == Name)
                {
                    return *(int*)(__int64(Property) + OffsetFix(Property, Offset, 8));
                }

                Property = *(FProperty**)(__int64(Property) + OffsetFix(Property, Next, 8));
                PropFName = (FName*)(__int64(Property) + OffsetFix(Property, Name, 8));
